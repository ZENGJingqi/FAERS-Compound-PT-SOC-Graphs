...
GRAPH_DIRS = {
    "ge10": STEP6_DIR / "step6_core_graph_ge10" / "step6_compound_pt_soc_core_ge10.sqlite",
    "ge20": STEP6_DIR / "step6_core_graph_ge20" / "step6_compound_pt_soc_core_ge20.sqlite",
    "ge30": STEP6_DIR / "step6_core_graph_ge30" / "step6_compound_pt_soc_core_ge30.sqlite",
}
...
def sync_graphs_to_package() -> None:
    ...
    for name in ["step6_core_graph_ge10", "step6_core_graph_ge20", "step6_core_graph_ge30"]:
        src = STEP6_DIR / name
        dst = dst_root / name
        if dst.exists():
            shutil.rmtree(dst)
